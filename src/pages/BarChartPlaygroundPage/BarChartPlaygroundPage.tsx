...
export default function BarChartPlaygroundPage() {
  ...
  const [layoutOption, setLayoutOption] = useState(layoutOptions[0]);
        ...
        <div className='flex h-full w-3/5 grow flex-col items-start justify-start gap-6 overflow-auto rounded-md border p-6'>
          <div className='max-h-md min-h-xs w-full shrink-0'>
            ...
            <BarChart
              ...
              layout={layoutOption.value as any}
              data={mainExample}
              settings={{
                general: {
          ...
          <div className='flex items-start justify-between gap-6'>
            <div className='flex flex-col items-start justify-between gap-3'>
              <Select selectedOption={layoutOption} setOption={setLayoutOption} options={layoutOptions} />
